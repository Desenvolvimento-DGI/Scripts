...
AREATMP="/home/cdsr/p6/AWIF${ANOAPROCESSAR}/"
...
ARQUIVOSQL="/home/cdsr/p6/AWIFS_UPDATE_SCENE_${ANOAPROCESSAR}.sql"
echo '' > ${ARQUIVOSQL}
...
ARQLOGS="/home/cdsr/p6/quicklookawifs${ANOAPROCESSAR}.log"
...
LISTAANOMES="`\ls -1F ${ORIGEM} | grep ^${ANOAPROCESSAR} | grep '/' | sort`"
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1F | grep -i AWIFS_${ANOAPROCESSAR}`"
	# echo "${LISTAPERIODOS}"
