...
AREATMP='/home/cdsr/p6/LIS3201303/'
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1F | grep -i LISS3_20130321`"
	# echo "${LISTAPERIODOS}"
	...
	do
		...
		do
			...
			RESOLUCAO="`gdalinfo -proj4  ${ARQTIFFINAL} | grep -i 'Size is' | cut -c 8-22 `"
			...
			PERCENTUALMAXIMO=300    
                ...
                do
                        LARGURAQL=$((${LARGURA} * ${PERCENTUALATUAl} * 100 / 100000))
                        ALTURAQL=$((${ALTURA} * ${PERCENTUALATUAl} * 100 / 100000))
