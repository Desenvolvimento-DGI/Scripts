...
ARQUIVOSQL="/home/cdsr/p6/AWIFS_UPDATE_SCENE_2012.sql"
...
ARQLOGS="/home/cdsr/p6/quicklookawifs2012.log"
...
LISTAANOMES="`\ls -1F ${ORIGEM} | grep ^2012 | grep '/' | sort`"
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1F | grep -i AWIFS_2012`"
	# echo "${LISTAPERIODOS}"
