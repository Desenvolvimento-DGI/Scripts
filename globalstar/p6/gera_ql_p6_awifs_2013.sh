...
ARQUIVOSQL="/home/cdsr/p6/AWIFS_UPDATE_SCENE_2013.sql"
...
ARQLOGS="/home/cdsr/p6/quicklookawifs2013.log"
...
LISTAANOMES="`\ls -1F ${ORIGEM} | grep ^2013 | grep '/' | sort`"
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1F | grep -i AWIFS_2013`"
	# echo "${LISTAPERIODOS}"
