...
CMDGDALWARP='gdalwarp -t_srs EPSG:4326 -multi -of GTiff -r near -order 1  '
CMDREMOVER='rm -f '
...
ARQLOGS="/home/cdsr/p6/quicklook.log"
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1rF | grep -i LISS3_20`"
	# echo "${LISTAPERIODOS}"
	...
	do
		...
		do
			...
			cd ${AREATMP}			
			${CMDMERGE} -o ${ARQTIFFINAL} -of GTIFF -separate ${ARQUIVOTIFBAND5} ${ARQUIVOTIFBAND4} ${ARQUIVOTIFBAND3}
