...
ARQUIVOSQL="/home/cdsr/p6/AWIFS_UPDATE_SCENE_2011.sql"
...
ARQLOGS="/home/cdsr/p6/quicklookawifs2011.log"
...
LISTAANOMES="`\ls -1F ${ORIGEM} | grep ^2011 | grep '/' | sort`"
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1F | grep -i AWIFS_2011`"
	# echo "${LISTAPERIODOS}"
