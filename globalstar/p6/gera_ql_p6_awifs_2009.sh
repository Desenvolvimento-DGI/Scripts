...
ARQUIVOSQL="/home/cdsr/p6/AWIFS_UPDATE_SCENE_2009.sql"
...
ARQLOGS="/home/cdsr/p6/quicklookawifs2009.log"
...
LISTAANOMES="`\ls -1F ${ORIGEM} | grep ^2009 | grep '/' | sort`"
...
do
	...
	echo ""
	LISTAPERIODOS="`\ls -1F | grep -i AWIFS_2009`"
	# echo "${LISTAPERIODOS}"
