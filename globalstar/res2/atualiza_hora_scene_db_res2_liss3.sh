...
do
	...
	PERIODODIRS="`ls -1 | grep '^RES2_LIS' | sort`"
	...
	do
		...
		do
				...
				if [ -e "${ORIGEM}${ANOMESATUAL}/${PERIODOATUAL}/${ORBITAPONTOATUAL}" ]
				then
					...
					ARQUIVOSQL="/home/cdsr/res2/UPDATE_RES2LISS3_${SCENEID}.sql"
					...
					rm -f ${ARQUIVOSQL}
					echo "ANO_MES: ${ANOMESATUAL}   SATELITE_SENSOR_DATA: ${PERIODOATUAL}   ORBITA_PONTO: ${ORBITAPONTOATUAL}   DATA_HORA: ${DATAINGEST}"
