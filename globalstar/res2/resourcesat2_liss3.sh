...
ARQUIVOLOCK="${AREASCRIPTS}adm/resourcesat2_liss3.lock" 
...
do
	...
	ANO="`echo ${ARQUIVOTGZATUAL} | cut -c 12-15`"
	NOMEMES="`echo ${ARQUIVOTGZATUAL} | cut -c 9-11`"
	DIA="`echo ${ARQUIVOTGZATUAL} | cut -c 7-8`"
	ORBITA="`echo ${ARQUIVOTGZATUAL} | cut -c 16-18`"
