...
PATH=${PATH}:/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/home/cdsr/.local/bin:/home/cdsr/bin:/usr/local/gdal-1.11.1/bin:/usr/local/gdal-1.11.1/lib:/usr/local/gdal-1.11.1
export PATH
...
LISTAPERIODOS="`\ls -1 | grep -i RES2_AWIFS_`"
...
do
	...
	do
		...
		do
			...
			TIFFCORRIGIDO="${ORIGEM}${COORDATUAL}/${QUADRANTEATUAL}/${NOMEPADRAO}_CORRIGIDO.tif"
						
			PNGTRANSPARENTE="${ORIGEM}${COORDATUAL}/${QUADRANTEATUAL}/${NOMEPADRAO}_CORRIGIDO_TRANSPARENTE.png"                        
			PNGTRANSPARENTEBC="${ORIGEM}${COORDATUAL}/${QUADRANTEATUAL}/${NOMEPADRAO}CORRIGIDO_TRANSPARENTE_BC.png"
			PNGMODELO="${ORIGEM}${COORDATUAL}/${QUADRANTEATUAL}/${NOMEPADRAO}_MODELO.png"
