...
LISTAANOS="`\/bin/ls -1 | grep _ | sort`"
			...
			do
				...
				then
				  ...
				  then
					  ...
					  cp -fnv  ${DIRFINAL}/${QLSAIDAMIN}   ${DIRQL}${QL_ANOMES}/${NOVOQLSAIDAMIN}
					  cp -fnv  ${DIRFINAL}/${QLSAIDAPEQ}   ${DIRQL}${QL_ANOMES}/${NOVOQLSAIDAPEQ}
					  #cp -fnv  ${DIRFINAL}/${QLSAIDAMED}   ${DIRQL}${QL_ANOMES}/${NOVOQLSAIDAMED}
					  cp -fnv  ${DIRFINAL}/${QLSAIDAGRD}   ${DIRQL}${QL_ANOMES}/${NOVOQLSAIDAGRD}
