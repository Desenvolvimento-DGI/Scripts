...
ARQLOG="${HOMESCRIPT}aql_areas_sem_todas_as_bandas_${NUMPPID}.log"
...
do
       ...
       ARQS="`\/bin/ls -1r | grep -i ^LANDSAT5 | egrep '20101205|20100823|20100531|20100321'`"
       ...
       do
			...
			do
				...
				then
				  ...
				  ${PATHGDAL}gdalwarp -t_srs EPSG:4291 -multi -of GTiff -r near -order 1 ./${IMGAGEMTMP}  ./${IMGAGEMGEOREF}
