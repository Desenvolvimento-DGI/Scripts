...
ARQUIVOSCENEAQUA="/home/cdsr/aqua/INSERTSCENEAQUA.sql"
ARQUIVOSQLDELETE="/home/cdsr/aqua/DELETEAQUA.sql"

echo "" > ${ARQUIVOSQL}
echo "" > ${ARQUIVOSCENEAQUA}
...
ANO="`echo ${PARPERIODO} | cut -c 12-15`"
MES="`echo ${PARPERIODO} | cut -c 17-18`"
DIA="`echo ${PARPERIODO} | cut -c 20-21`"
HRA="`echo ${PARPERIODO} | cut -c 23-24`"
MIN="`echo ${PARPERIODO} | cut -c 26-27`"
SEG="`echo ${PARPERIODO} | cut -c 29-30`"
...
SQLINSERTAQUASCENE="INSERT INTO catalogo.ModisScene "
SQLINSERTAQUASCENE="${SQLINSERTAQUASCENE} ( SceneId,	Gralha, DRD ) " 
SQLINSERTAQUASCENE="${SQLINSERTAQUASCENE} VALUES " 
SQLINSERTAQUASCENE="${SQLINSERTAQUASCENE} ( '${SCENEID}', '${GRALHA}', '${DRD}' ) ;" 
echo "${SQLINSERTAQUASCENE}" >> ${ARQUIVOSCENEAQUA}
echo "" >> ${ARQUIVOSCENEAQUA}
echo -n "."
${CMDMYSQL} < ${ARQUIVOSQL}
${CMDMYSQL} < ${ARQUIVOSCENEAQUA}
echo "."
