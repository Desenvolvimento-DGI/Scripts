...
cd ${HOMESCRIPT}
 ...
 do
	...
	cd ${ORIGEML1}${ANOMES}
	LISTAPERIODOS="`\ls -1 | grep ${PARPERIODO} `"
	...
	do
		...
		do
				...
				TIFFCORRIGIDOBC="${ORIGEM}${COORDATUAL}/${NOMEPADRAO}_CORRIGIDO_BC.tif"
				...
				rm -fv ${TIFFSAIDA} ${TIFFCORRIGIDO} ${TIFFCORRIGIDOBC}
				...
				${PATHGDAL}gdal_translate -of GTIFF -outsize 40% 40%  ${PNGTRANSPARENTE}  ${PNGMODELO}
				...
				echo ""
				echo "Copiando quicklooks gerados para a área container de todoas os quicklooks ..."
