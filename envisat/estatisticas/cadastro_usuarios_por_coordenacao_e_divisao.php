<?php
//error_reporting(E_ALL ^ E_DEPRECATED); // Nãresenta as mensagens relacionadas a comandos 
...
// String contendo a instrucao de pesquisa e agrupamento para todos os usuá
...
// String contendo a instrucao de pesquisa e agrupamento para usuá internos
...
echo "\n";
echo "Estatisticas de Usuá Cadastrados - Internos e Externos\n";
echo "Periodo: " . $mensagemAno;
echo "\n";
echo "\n";
echo "Todos Usuarios - Internos e Externos\n";
echo "------------------------------------\n\n";
// Todos os Usuá - Internos e Externos	
