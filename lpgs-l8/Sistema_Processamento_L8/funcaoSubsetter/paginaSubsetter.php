...
<div class="container">
    ...
    <table>
        <form action="executaSubsetter.php" method="post">
         <tr>
         ...
         <tr>
            <td>
                ...
                <select name="ano_mes">
                    ...
                    ?>
                            <option value="<?php echo $valor_ano_mes; ?>" onclick="document.location=('paginaSubsetter.php?ano_mes=<?php echo $valor_ano_mes?>');">
            ...
            <tr>
                <td>
                    ...
                    <?php
                        ...
                        $lista_de_passagens = $_METODO->listaDadosL0Ra_PorAnoMes($ano_mes);
                        ...
                        for ($j = 0; $j < $count; $j++)
                        {
                            ...
                            echo $tamanho_nome_arquivo = strlen($valor_passagem_exibir[1]);
        ...
        <tr>
            <td>
            	<button class="btn btn-success">SUBSETTER</button>
            </td>
        </tr>
