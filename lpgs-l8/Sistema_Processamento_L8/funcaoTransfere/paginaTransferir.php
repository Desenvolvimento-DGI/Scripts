...
?>
<table>
	<form action="executaFuncaoTransferir.php" method="post">
	 <tr>
     	<th colspan="2">SELECIONE OS DADOS PARA MOSTRAR AS PASSAGENS</th>
     ...
     <tr>
     	<td>
            ...
            <select name="ano_mes">
                ...
                ?>
						<option value="<?php echo $valor_ano_mes; ?>" onclick="document.location=('paginaTransferir.php?ano_mes=<?php echo $valor_ano_mes?>');">
